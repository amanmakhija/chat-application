...
export default function Settings() {
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    formData.append(
      "avatar",
      (data.avatar && data.avatar[0]) || previewAvatar || ""
    );
    await axios
  ...
  return (
    <div className="pb-8">
      <header className="h-[6rem] p-3 md:p-6 flex items-center gap-4 border-b border-neutral-800">
        ...
        <h1 className="scroll-m-20 text-2xl md:text-3xl font-semibold tracking-tight first:mt-0">
          Settings
        </h1>
      </header>
        ...
        <section className="p-3 md:p-6 rounded-2xl border border-neutral-800">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormItem>
                    ...
                    <FormDescription
                      className={`ml-auto w-fit ${
                        bio && bio.length > 300 && "text-red-500"
                      }`}
                    >
              ...
              <Button
                variant="secondary"
                disabled={!!loading || (!!bio && bio.length > 300)}
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  ...
                  be undone. This will permanently delete your account and your
